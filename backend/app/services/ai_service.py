    ...
    async def analyze_text(self, text: str, user_context: Optional[str] = None, target_language: str = "Original", previous_context: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            default_prompt: str = (
                ...
                "18. 'clarifying_question': (String|Null) If you are unsure about a priority, entity, or preference, ask the user specifically. E.g. 'Is P0 considered High or Urgent?'.\n\n"
